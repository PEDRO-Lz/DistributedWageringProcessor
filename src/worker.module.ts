...
@Module({
  ...
  providers: [
...

    {
      ...
      useFactory: (em, sqs, inboxRepository, submitUseCase) =>
    ...
    },
    {
      ...
      useFactory: (em, outboxRepository, sqs) =>
        new PublishOutboxBatchUseCase(em, outboxRepository, sqs),
      inject: [ENTITY_MANAGER, OUTBOX_REPOSITORY, SQS_PORT],
    },
    {
